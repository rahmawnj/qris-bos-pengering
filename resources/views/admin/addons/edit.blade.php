    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('admin.addons.update', $addon->id) }}" method="POST">
                @csrf
                @method('PUT') {{-- Pastikan menggunakan PUT atau PATCH sesuai rute Anda --}}
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror"
                        id="is_active" name="is_active" value="1" {{ old('is_active', $addon->is_active) ? 'checked' : '' }}>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // 'old' helper akan mengambil precedence jika ada error validasi
            // jika tidak ada error validasi, maka akan menggunakan nilai dari $addon->is_active.
