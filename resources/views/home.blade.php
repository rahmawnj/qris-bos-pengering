...
@section('container')
    <div class="page-content">
        ...
        <div class="twm-home1-banner-section site-bg-gray bg-cover"
            style="background-image:url({{ asset('assets/images/main-slider/slider1/bg1.jpg') }})">
            <div class="row">

                <!--Left Section-->
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="twm-bnr-left-section">
                        <div class="twm-bnr-title-small">We Have <span class="site-text-primary">208,000+</span> Live Jobs
                        </div>
                        <div class="twm-bnr-title-large">Find the <span class="site-text-primary">job</span> that fits your
                            life</div>
                        <div class="twm-bnr-discription">Type your keyword, then click search to find your perfect job.
                        </div>
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="form-group col-xl-3 col-lg-6 col-md-6">
                                        <label>What</label>
                                        <select class="wt-search-bar-select selectpicker" data-live-search="true"
                                            title="" id="j-Job_Title" data-bv-field="size">
                    ...
                    <div class="twm-bnr-right-content">
                        ...
                        <div class="twm-bnr-right-carousel">
                            <div class="owl-carousel twm-h1-bnr-carousal">
                                <div class="item">
                                    <div class="slide-img">
                                        <img src="{{ asset('assets/images/main-slider/slider1/r-img1.png') }}"
                                            alt="#">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="slide-img">
                                        <div class="slide-img">
                                            <img src="{{ asset('assets/images/main-slider/slider1/r-img2.png') }}"
                                                alt="#">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="twm-bnr-blocks-position-wrap">
                                ...
                                <div class="twm-bnr-blocks twm-bnr-blocks-position-1">
                                    <div class="twm-icon">
                                        <img src="{{ asset('assets/images/main-slider/slider1/icon-1.png') }}"
                                            alt="">
                                    </div>
                                ...
                                <div class="twm-bnr-blocks twm-bnr-blocks-position-2">
                                    <div class="twm-icon">
                                        <img src="{{ asset('assets/images/main-slider/slider1/icon-2.png') }}"
                                            alt="">
                                    </div>
                                    <div class="twm-content">
                                ...
                                <div class="twm-bnr-blocks-3 twm-bnr-blocks-position-3">
                                    <div class="twm-pics">
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-1.jpg') }}"
                                                alt=""></span>
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-2.jpg') }}"
                                                alt=""></span>
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-3.jpg') }}"
                                                alt=""></span>
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-4.jpg') }}"
                                                alt=""></span>
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-5.jpg') }}"
                                                alt=""></span>
                                        <span><img src="{{ asset('assets/images/main-slider/slider1/user/u-6.jpg') }}"
                                                alt=""></span>
                                    </div>
                                    <div class="twm-content">
                ...
                <div class="wt-separator-two-part">
                    <div class="row wt-separator-two-part-row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 wt-separator-two-part-right">
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry the standard dummy
                                text ever since the when an printer took.</p>
                        </div>
                    ...
                    <div class="owl-carousel home-client-carousel2 owl-btn-vertical-center">
                            ...
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w1.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w2.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w3.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w4.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w5.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                    <a href="employer-list.html"><img
                                            src="{{ asset('assets/images/client-logo/w6.png') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul>
                                ...
                                <div class="twm-jobs-list-style1 mb-5">
                                    ...
                                    <div class="twm-mid-content">
                                        <a href="job-detail.html" class="twm-job-title">
                                            <h4>Senior Web Designer , Developer <span class="twm-job-post-duration">/ 1
                                                    days ago</span></h4>
                                        </a>
                                        <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                        <a href="../../external.html?link=https://themeforest.net/user/thewebmax/portfolio"
                            ...
                            <li>
                                <div class="twm-jobs-list-style1 mb-5">
                                    ...
                                    <div class="twm-mid-content">
                                        <a href="job-detail.html" class="twm-job-title">
                                            <h4>Need Senior Rolling Stock Technician<span class="twm-job-post-duration">/
                                                    15 days ago</span></h4>
                                        </a>
                                        <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                        <a href="../../external.html?link=https://themeforest.net/user/thewebmax/portfolio"
                                    ...
                                    <div class="twm-right-content">
                                        <div class="twm-jobs-category green"><span class="twm-bg-brown">Intership</span>
                                        </div>
                            ...
                            <li>
                                <div class="twm-jobs-list-style1 mb-5">
                                    ...
                                    <div class="twm-right-content">
                                        <div class="twm-jobs-category green"><span class="twm-bg-purple">Fulltime</span>
                                        </div>
                            ...
                            <li>
                                <div class="twm-jobs-list-style1 mb-5">
                                    ...
                                    <div class="twm-right-content">
                                        <div class="twm-jobs-category green"><span class="twm-bg-sky">Freelancer</span>
                                        </div>
                            ...
                            <div class="twm-testimonial-1">
                                <div class="twm-testimonial-1-content">
                                    ...
                                    <div class="twm-testi-content">
                                        ...
                                        <div class="twm-testi-info">I just got a job that I applied for via careerfy! I
                                            used the site all the time during my job hunt.</div>
                        ...
                        <div class="owl-carousel twm-la-home-blog owl-btn-bottom-center">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img
                                                src="{{ asset('assets/images/blog/latest/bg1.jpg') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-meta ">
                                            <ul>
                                                ...
                                                <li class="post-author">By <a href="candidate-detail.html">Mark Petter</a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="item">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img
                                                src="{{ asset('assets/images/blog/latest/bg2.jpg') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-meta ">
                                            <ul>
                                                <li class="post-date">March 05, 2023</li>
                                                <li class="post-author">By <a href="candidate-detail.html">David Wish</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="wt-post-title ">
                            ...
                            <div class="item">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img
                                                src="{{ asset('assets/images/blog/latest/bg3.jpg') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-meta ">
                                            <ul>
                                                <li class="post-date">March 05, 2023</li>
                                                <li class="post-author">By <a href="candidate-detail.html">Mike Doe</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="wt-post-title ">
